...
The project is now setup for unit testing using `mocha`, `chai`, and `karma` test runner. A simple exampe unit test is included in `scripts/logic/messageHelper.tests.ts`, to run tests just execute:
